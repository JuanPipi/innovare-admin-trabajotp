...
import { Search, Target, GitBranch, Users, Monitor, TrendingUp } from "lucide-react";
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((s, i) => (
          <ScrollReveal key={s.title} delay={i * 100}>
            <div className="group bg-card rounded-xl p-7 shadow-card hover:shadow-card-hover transition-all duration-300 border border-border hover:border-blue-accent/30 hover:-translate-y-1">
              ...
              <h3 className="font-sans text-lg font-bold text-primary mb-2">{s.title}</h3>
