...
const navLinks = [
  ...
  { label: "Análisis TP", href: "#analisis" },
    ...
    >
      <div className="container mx-auto flex items-center justify-between h-14 md:h-16 px-4 lg:px-8">
        ...
        <a href="#inicio" onClick={(e) => handleNav(e, "#inicio")} className="flex items-center gap-2.5">
          ...
          <span className={`text-base font-serif font-bold tracking-tight transition-colors ${scrolled ? "text-primary" : "text-primary-foreground"}`}>
            Innovare
          </span>
        </a>
